...
#include <std_msgs/Empty.h>   // start_cmd, stop_cmd 콜백에서 사용 가능
...
namespace mppi {
    ...
    private:
        ...
        ros::Subscriber sub_global_path_;  // (추가) 글로벌 경로 구독
        ...
        void callbackGlobalPath(const nav_msgs::PathConstPtr& msg);
